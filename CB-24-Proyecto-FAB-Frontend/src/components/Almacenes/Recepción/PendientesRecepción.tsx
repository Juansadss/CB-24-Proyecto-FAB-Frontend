...
function PendientesRecepcion() {
    const location = useLocation();
   
    const [items, setItems] = useState(location.state?.itemsNormal ||  [
        {
            id: 1,
            tipo: 'Fusilajes',
            nroDeParte: '1234-ABC',
    ...
    const [itemsOther, setItemsOther] = useState(location.state?.itemsOther ||  [
        {
          id: 1,
          tipo: 'Agua',
          nroDeParte: '1234-H2O',
    ...
    const switchChanged = () => {
        n("/almacenes/recepcion/pendientesOtros", {state:{incomeItems:incomeItems, itemsNormal:items, itemsOther: itemsOther}});
...
function PendientesRecepcionExport() {
    return (
        <SlideBar ContentComp={PendientesRecepcion} menuItem='Recepción de Material' >

        </SlideBar>)
}

export default PendientesRecepcionExport