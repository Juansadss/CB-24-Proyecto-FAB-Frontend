...
const handlePieceClick = (user) => {
      ...
      <div className="flex flex-col gap-4">
        ...
        <div className="flex justify-between items-center">
          <span className="text-default-400 text-small">
            Total de Inspecciones: {pieces.length}
          </span>
  ...
  return (
    <>
      <>
        <h1 id="title1">
          <b>MANTENIMIENTO</b> - Control de Inspecciones
        </h1>

        <h2 id="sub1">
          INSPECCIONES DEL HELICOPTERO FAB-004 MODELO BK117 C-2 EC 145 (9562)
        </h2>
        <h3 id="sub2">
          {" "}
          <b>TOTAL HORAS NAVE:</b> 2474:21:00
        </h3>
        <br />
        ...
        {showDialog && (
          <div className="dialog">
            ...
            <div className="dialog-content">
              ...
              <Table>
                <TableHeader>
                  <TableColumn className="custom-column"></TableColumn>{" "}
                  {/*Checkbox*/}
                ...
                <TableBody>
                  {data.map((item, index) => (
                    <TableRow key={index}>
                      ...
                      <TableCell
                        className={`custom-table-cell ${item.estado.toLowerCase()}`}
                      >
                        {item.estado}
                      </TableCell>
                      <TableCell className="custom-table-cell">
      ...
      <footer>
        {" "}
        <img id="logoFoto" src="logo.png" alt="" />{" "}
      </footer>
    </>
  );
}
