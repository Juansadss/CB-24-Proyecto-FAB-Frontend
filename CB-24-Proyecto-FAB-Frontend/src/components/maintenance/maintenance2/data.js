...
const statusOptions = [
  ...
  { name: "En Pausa", uid: "Pausa" },
  { name: "En Reparación", uid: "Reparacion" },
];

const data = [
  { pieza: "MOTOR JT8B", categoria: "TURBOFAN", estado: "ACTIVO", descripcion: "Motor de aviación", ubicacion: "Hangar 3" },
  { pieza: "MOTOR JT8D", categoria: "TURBOFAN", estado: "ACTIVO", descripcion: "Motor de aviación", ubicacion: "Hangar 1" },
  { pieza: "MOTOR CF6", categoria: "TURBOFAN", estado: "PAUSA", descripcion: "Motor de aviación", ubicacion: "Hangar 2" },
  { pieza: "MOTOR PW4000", categoria: "TURBOFAN", estado: "REPARACION", descripcion: "Motor de aviación", ubicacion: "Hangar 3" },
  { pieza: "MOTOR JT8B", categoria: "TURBOFAN", estado: "ACTIVO", descripcion: "Motor de aviación", ubicacion: "Hangar 3" },
  { pieza: "MOTOR JT8B", categoria: "TURBOFAN", estado: "ACTIVO", descripcion: "Motor de aviación", ubicacion: "Hangar 3" },
  { pieza: "MOTOR JT8B", categoria: "TURBOFAN", estado: "ACTIVO", descripcion: "Motor de aviación", ubicacion: "Hangar 3" },
  { pieza: "MOTOR JT8B", categoria: "TURBOFAN", estado: "ACTIVO", descripcion: "Motor de aviación", ubicacion: "Hangar 3" },
